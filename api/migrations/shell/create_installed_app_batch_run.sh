...
(
    ...
    from_pro character varying(255) NOT NULL,
    input_tb_id character varying(255) NOT NULL,
    input_tb_name character varying(255) NOT NULL,
    output_tb_id character varying(255) NOT NULL,
    output_tb_name character varying(255) NOT NULL,
    created_at timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    ...
    error_msg text,
    folder_from character varying(255) NOT NULL DEFAULT ''::character varying,
